...
const IntroPage = () => {
  return (
    <View style={styles.introPage}>
      <Image
        style={[styles.mapIcon, styles.amPosition]}
        resizeMode="cover"
        source={require("../assets/map.png")}
      />
      <View style={[styles.vehicleMode, styles.vehicleLayout3]}>
        <View style={[styles.vehicleModeChild, styles.childPosition]} />
        <Image
          style={[styles.vehicleModeItem, styles.vehicleLayout]}
          resizeMode="cover"
          source={require("../assets/group-2.png")}
        />
        <Image
          style={[styles.vehicleModeInner, styles.vehicleLayout]}
          resizeMode="cover"
          source={require("../assets/group-2.png")}
        />
        <Image
        ...
        />
        <Text style={[styles.m, styles.mFlexBox]}>12m</Text>
        <Text style={[styles.m1, styles.mFlexBox]}>12m</Text>
      </View>
      <Image
      ...
      <View style={[styles.display, styles.displayLayout]}>
        ...
        <View style={[styles.displayInner, styles.groupParentFlexBox]}>
          <View style={styles.groupParentFlexBox}>
            <View style={styles.amLayout}>
              <Text style={[styles.departure, styles.pmTypo]}>Departure</Text>
            ...
            <View style={styles.pmParent}>
              ...
              <Text style={[styles.estimatedDestination, styles.pmTypo]}>
        ...
        />
        <View style={[styles.rectangleParent, styles.vehicleLayout]}>
          <View style={[styles.groupChild, styles.vehicleLayout]} />
